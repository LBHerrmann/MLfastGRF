...
public:
    ...
    /// Allows for some optimization in the evaluation of bilinear forms
    static constexpr bool isPiecewiseConstant( ) {
        return true;
    }
    //@}
...
public:
    ...
    //@{
    typename gridFunctionTraits_t::elementIterator_t begin() const {
        return entity_collection_.begin();
    }
    typename gridFunctionTraits_t::elementIterator_t end()   const {
        return entity_collection_.end();
    }
    //@}
